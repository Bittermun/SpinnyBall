...
from dynamics.gravity_slingshot import GravitySlingshotOptimizer, SlingshotTrajectory
from dynamics.velocity_optimizer import OptimizationStrategy, VelocityOptimizer
...
def main():
    ...
    system.run_mission_simulation(duration=5.0, dt=0.001)
