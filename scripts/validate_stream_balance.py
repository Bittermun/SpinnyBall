...
from monte_carlo.pass_fail_gates import GateResult, StreamBalanceGate
...
def run_monte_carlo(
    ...
    with open(output_path / "stream_balance_monte_carlo.json", "w") as f:
        ...
        save_dict["results"] = list(results[:10])  # Save first 10 for inspection
