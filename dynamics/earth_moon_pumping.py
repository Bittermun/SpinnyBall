...
try:
    from dynamics.bean_london_model import BeanLondonModel  # noqa: F401
    from dynamics.flux_gyroscopic_dynamics import (
        FluxGyroConfig,  # noqa: F401
        FluxGyroscopicCoupledSystem,
        FluxGyroState,
        create_fast_rotor_config,
    )
    from dynamics.gravity_slingshot import GravityBody, GravitySlingshotOptimizer  # noqa: F401
except ImportError:
    ...
    from gravity_slingshot import GravitySlingshotOptimizer
...
class EarthMoonPumpingSimulator:
    ...
    def compute_acceleration(
        ...
        self.get_moon_velocity(state.t)
    ...
    def execute_lunar_slingshot(self, state: BallState) -> float:
        ...
        """
        # Get Moon state
        self.get_moon_position(state.t)
