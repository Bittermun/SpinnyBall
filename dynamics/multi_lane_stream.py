...
try:
    from .orbital_coupling import (
        ORBITAL_DYNAMICS_AVAILABLE,  # noqa: F401
        CouplingResult,
        StationState,
...
class MultiLaneStream:
    ...
    def __init__(self, custom_lanes: list[StreamLane] | None = None):
        """
    ...
    def find_matching_lane(
        ...
        v_relative_override: float | None = None
    ) -> StreamLane | None:
        """
    ...
    def process_lunar_injection(
        ...
        timestamp: float = 0.0
    ) -> tuple[StreamLane | None, CouplingResult, PacketStreamEvent | None]:
        """
    ...
    ) -> tuple[StreamLane | None, CouplingResult, PacketStreamEvent | None, np.ndarray]:
        """
